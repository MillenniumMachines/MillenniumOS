...
if { !state.atxPower }
    M291 P{"<b>CAUTION</b>: Machine Power is currently <b>deactivated</b>. Do you want to <b>activate</b> machine power?<br/>Check the machine is in a safe state before pressing <b>Activate</b>!"} R"MillenniumOS: Safety Net" S4 K{"Activate", "Cancel"} F1
    if { input == 0 }
        M80
