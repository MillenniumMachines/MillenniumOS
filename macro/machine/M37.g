...
if exists(global.mosTAID)                 ; Check if air control pin is defined
    M42 P{global.mosTAID} S1               ; Turn on air using defined pin
    G4 S5
    M42 P{global.mosTAID} S0               ; Turn off air using defined pin
...
if exists(global.mosCAID)                 ; Check if air was turned on
    G4 S1                                   ; Keep air on briefly after measurement
