...
set global.mosProbeCoordinate[0] = { ceil(global.mosProbeCoordinate[0] * var.sDig) / var.sDig }
set global.mosProbeCoordinate[1] = { ceil(global.mosProbeCoordinate[1] * var.sDig) / var.sDig }
set global.mosProbeCoordinate[2] = { ceil(global.mosProbeCoordinate[2] * var.sDig) / var.sDig }