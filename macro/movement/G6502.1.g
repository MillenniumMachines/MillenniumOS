...
G6510.1 K{global.mosTouchProbeID} J{param.J} K{param.K} L{param.L} X{dirX[0]}
set var.pX[0] = { global.mosProbeCoordinate[global.mosIX] }

; Probe edge max on X axis
G6510.1 K{global.mosTouchProbeID} J{param.J} K{param.K} L{param.L} X{dirX[1]}
...
G6510.1 K{global.mosTouchProbeID} J{global.mosRectanglePocketCenterPos[0]} K{param.K} L{param.L} Y{dirY[0]}
set var.pY[0] = { global.mosProbeCoordinate[global.mosIY] }

; Probe edge max on Y axis, using the X center of the pocket
G6510.1 K{global.mosTouchProbeID} J{global.mosRectanglePocketCenterPos[0]} K{param.K} L{param.L} Y{dirY[1]}
